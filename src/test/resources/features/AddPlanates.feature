...
#      | Treader -2_2                                           |giff    | Invalid File Type |
    ...
    @PR1 @PR2 @PR3 @PR6
    Scenario Outline:  User can not add new planets with invalid image files
      When the user provides a add planet name "<planetName>"
      ...
      Examples:
        |PlanetName    | Image                                                                                                 | alert                |
        |Treader -2_2  | C:\Users\eskro\OneDrive\Desktop\Testing project 1\Planetarium_Project\dscovrepicmoontransitfull.webp  | Invalid File Type    |
        |Treader -2_2  | C:\Users\eskro\OneDrive\Desktop\Testing project 1\Planetarium_Project\dscovrepicmoontransitfull.webp  | Invalid File Type    |